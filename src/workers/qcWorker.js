...
const OUTCOME_TAGS = ['DISQUALIFIED','NOT_READY','LONG_TERM_NURTURE','INFO_SEEKER','SHORT_TERM_NURTURE','REDZONE_HOT','HARD_NO','SET','CLOSED_WON','PARTNERSHIP_CALL','BNB_LEGACY'];
